...
import (
	...
	apisCluster "github.com/buttahtoast/provider-tailscale/apis/cluster"
	apisNamespaced "github.com/buttahtoast/provider-tailscale/apis/namespaced"
	"github.com/buttahtoast/provider-tailscale/config"
	"github.com/buttahtoast/provider-tailscale/internal/clients"
	controllerCluster "github.com/buttahtoast/provider-tailscale/internal/controller/cluster"
	controllerNamespaced "github.com/buttahtoast/provider-tailscale/internal/controller/namespaced"
	"github.com/buttahtoast/provider-tailscale/internal/features"
	"github.com/buttahtoast/provider-tailscale/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped Tailscale APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced Tailscale APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped Tailscale controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced Tailscale controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped Tailscale controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced Tailscale controllers")
	}
