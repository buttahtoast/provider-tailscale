...
func (mg *Identity) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this Identity.
func (mg *Identity) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *Identity) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this Identity.
func (mg *Identity) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
