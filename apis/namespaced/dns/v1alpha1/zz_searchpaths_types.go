...
type SearchPathsInitParameters struct {
	...
	// (List of String) Devices on your network will use these domain suffixes to resolve DNS names.
...
// SearchPaths is the Schema for the SearchPathss API. The dns_search_paths resource allows you to configure DNS search paths for your Tailscale network. See https://tailscale.com/kb/1054/dns for more information.
