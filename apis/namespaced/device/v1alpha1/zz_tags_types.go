...
type TagsInitParameters struct {
	...
	// (String) The device to set tags for
	// The device to set tags for
	DeviceID *string `json:"deviceId,omitempty" tf:"device_id,omitempty"`

	// (Set of String) The tags to apply to the device
...
// Tags is the Schema for the Tagss API. The device_tags resource is used to apply tags to Tailscale devices. See https://tailscale.com/kb/1068/acl-tags/ for more details.
