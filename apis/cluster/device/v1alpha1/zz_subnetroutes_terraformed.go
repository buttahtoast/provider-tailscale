...
// GetInitParameters of this SubnetRoutes
func (tr *SubnetRoutes) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SubnetRoutes
func (tr *SubnetRoutes) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
