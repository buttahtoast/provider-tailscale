...
// GetInitParameters of this Tags
func (tr *Tags) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Tags
func (tr *Tags) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
